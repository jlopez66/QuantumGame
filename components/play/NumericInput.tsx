...
import type { NumericInputStep } from "@/lib/game/rounds";
...
export function NumericInput({ step, endsAt, onSubmit }: Props) {
  ...
  return (
    <div className="flex min-h-screen flex-col gap-6 px-6 py-8">
      <div className="flex items-center justify-between">
        <div>
          <p className="font-body text-xs uppercase tracking-widest text-brand-cyan">Juego 1 · {step.points} pts</p>
